...
const capture_manager_1 = require("./capture-manager");
class BrowserManager {
    ...
    async launch(options = {}) {
        ...
        const captureManager = new capture_manager_1.CaptureManager();
    ...
    async getVisibleElements(pageId) {
        const page = this.getPage(pageId);
    ...
    async waitForSelector(pageId, selector, timeout) {
        const page = this.getPage(pageId);
